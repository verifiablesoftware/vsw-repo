...
def _registered_commands(
        group: str = "vsw_repo.registered_commands",
...
def dispatch(argv: List[str]) -> Any:
    ...
    parser = argparse.ArgumentParser(prog="vsw-repo")
    parser.add_argument(
        "--version",
        action="version",
        version="%(prog)s version {}".format(pkg_resources.require("vsw_repo")[0].version),
    )
    parser.add_argument(
        "command",
